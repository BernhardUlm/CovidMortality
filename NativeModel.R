...
openxlsx::write.xlsx(beste_vor_pandemie,"Bewegungsdaten/BewegungsdatenWS/ModelleCovid/besteAlgos_vor_pandemie.xlsx")
openxlsx::write.xlsx(beste_in_pandemie,"Bewegungsdaten/BewegungsdatenWS/ModelleCovid/besteAlgos_in_pandemie.xlsx")
...
ggsave("Bewegungsdaten/BewegungsdatenWS/ModelleCovid/AUPR Veränderung.jpg")
...
ggsave("Bewegungsdaten/BewegungsdatenWS/ModelleCovid/AUROC Veränderung aufgeteilt nach Modellen.jpg")
...
ggsave("Bewegungsdaten/BewegungsdatenWS/ModelleCovid/AUPR Veränderung aufgeteilt nach Modellen.jpg")
...
library(export)
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PowerPointGrafiken/ROC_GBM.pptx")
ggsave("~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/ROCC_GBM.jpg")
...
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PowerPointGrafiken/PR_GBM.pptx")
ggsave("~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PR_GBM.jpg")
...
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PowerPointGrafiken/pdp_1.pptx")
#2
...
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PowerPointGrafiken/pdp_2.pptx")
#3
...
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PowerPointGrafiken/pdp_3.pptx")
...
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PowerPointGrafiken/pdp_4_fach.pptx")
...
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PowerPointGrafiken/pdp_4_Department.pptx")
...
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PowerPointGrafiken/pdp_5.pptx")
...
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PowerPointGrafiken/pdp_6.pptx")
...
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PowerPointGrafiken/pdp_7.pptx")
...
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PowerPointGrafiken/pdp_8.pptx")
...
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PowerPointGrafiken/pdp_9.pptx")
...
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/PowerPointGrafiken/pdp_10.pptx")
...
graph2ppt(file="~/LRZ Sync+Share/Schnittstelle Risiko (Manfred Blobner)/Endlager Publikationen/Endpunkt Mortality/Bestes Modell für COVID/Grafiken/PowerPointGrafiken/Änderung AUC änderung PR BiasVariance.pptx")
